Public Class VazorPage
    ...
    Public Shared Function CreateNew(name As String, path As String, title As String, html As String) As String
        Return VazorViewMapper.Add(New VazorPage(name, path, title, html))
    End Function
